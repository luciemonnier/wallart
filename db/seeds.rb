...
Photo.delete_all
Tagging.delete_all
MediaToPackageLink.delete_all
Media.delete_all
Package.delete_all

puts '...'
Package.new(name: "Découverte", price: 20000).save
Package.new(name: "Premium", price: 30000).save
...
100.times do
  ...
  media_to_package_link = MediaToPackageLink.new(
    media: media,
    package: Package.all.sample)
  media_to_package_link.save
end
...
urls = ["https://res.cloudinary.com/drsqjyhts/image/upload/v1561475167/xohjnaicvktzfqwfjqyc.jpg"]
